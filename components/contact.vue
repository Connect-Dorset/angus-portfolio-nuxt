<template> 
    <div id="contact" class=" w-full h-auto md:h-full overflow-x-hidden py-5 flex flex-col items-center bg-soft-peach-50">
      ...
      <div class="flex flex-col md:flex-row justify-evenly items-center h-full text-mine-shaft-800">
        ...
        <div class="h-8/12 w-full flex flex-col md:flex-row justify-evenly items-center px-4 md:px-12 gap-4  " >
          <div class="gap-y-4 bg-soft-peach-100 md:w-10/12 h-full gap-3 flex flex-col justify-center items-center text-center rounded-lg px-6 py-5">
            <h2 class="text-xl">Drop me a Message!</h2>
            <div class="grid grid-cols-3 gap-y-4 items-center w-full">
            ...
            <button class="bg-mine-shaft-400 hover:bg-mine-shaft-300 text-soft-peach-100 hover:cursor-pointer px-2 py-1 lg:px-4 lg:py-2 rounded-xl mt-3">Send Message!</button>
